...
import 'devices_list_model.dart';
export 'devices_list_model.dart';
...
class _DevicesListWidgetState extends State<DevicesListWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DevicesListModel());
